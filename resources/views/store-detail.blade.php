      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
        ...
        <div>
          ...
          <div class="bg-teal-50 dark:bg-teal-900/30 border-l-4 border-teal-500 p-4 rounded-lg mb-4">
            ...
            <p class="text-slate-600 dark:text-slate-400 text-xs leading-relaxed"><strong>Timezone:</strong> All timestamps in Singapore Time (SGT, UTC+8). <strong>Coverage:</strong> 46 stalls across Singapore monitored in real-time.</p>
          </div>
