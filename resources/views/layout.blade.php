  ...
  <div class="min-h-screen flex">
    ...
    <aside class="w-72 hidden md:flex flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 relative z-20">
      <div class="px-6 py-5 flex items-center gap-3">
        <img src="/images/logo-light.png?v=2" class="h-10 w-10 rounded-xl object-cover dark:hidden" alt="HO">
        <img src="/images/logo-dark.png?v=2"  class="h-10 w-10 rounded-xl object-cover hidden dark:block" alt="HO">
        <div class="flex-1">
  ...
  <div id="mobile-drawer"
    ...
    <div class="flex items-center justify-between px-5 py-4 border-b border-slate-200 dark:border-slate-800">
      <div class="flex items-center gap-3">
        <img src="/images/logo-light.png?v=2" class="h-9 w-9 rounded-xl object-cover dark:hidden" alt="HO">
        <img src="/images/logo-dark.png?v=2"  class="h-9 w-9 rounded-xl object-cover hidden dark:block" alt="HO">
        <div>
