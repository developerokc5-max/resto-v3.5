      ...
      <header class="sticky top-0 z-10 bg-white/80 dark:bg-slate-900/80 backdrop-blur border-b border-slate-200 dark:border-slate-800">
        <div class="px-4 md:px-6 py-3 md:py-3 flex items-center gap-2">
          ...
          <div class="flex items-center gap-2 flex-shrink-0">
            ...
            <a href="/logout" title="Sign out ({{ session('auth_user') }})"
              class="rounded-xl bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 px-3 py-2 text-sm font-medium hover:opacity-80 transition flex items-center gap-1.5">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
        ...
        <div>
          ...
          <div class="bg-teal-50 dark:bg-teal-900/30 border-l-4 border-teal-500 p-4 rounded-lg mb-4">
            ...
            <p class="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">All timestamps in Singapore Time (SGT, UTC+8). 50 outlets monitored.</p>
          </div>
