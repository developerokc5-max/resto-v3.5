  ...
  <div id="mobile-drawer"
    ...
    <div class="flex items-center justify-between px-5 py-4 border-b border-slate-200 dark:border-slate-800">
      <div class="flex items-center gap-3">
        <img src="/images/logo-light.png" class="h-9 w-9 rounded-xl object-cover dark:hidden" alt="HO">
        <img src="/images/logo-dark.png"  class="h-9 w-9 rounded-xl object-cover hidden dark:block" alt="HO">
        <div>
