...
<a href="/history" class="rounded-xl bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 text-sm font-semibold transition shadow-sm flex items-center gap-2">
...
@section('content')
  ...
  <!-- Last Scrape Time -->
  <div class="flex items-center gap-1.5 text-xs text-slate-400 dark:text-slate-500 -mt-1">
    <svg class="w-3.5 h-3.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
    </svg>
    <span>Last scrape: <span class="font-medium text-slate-500 dark:text-slate-400">{{ $lastSync ?? 'Never' }}</span></span>
  </div>
